  ...
  function peg$parse(input) {
    ...
    function peg$parsebrivla_core() {
      ...
      if (s2 !== peg$FAILED) {
        ...
        if (s3 !== peg$FAILED) {
          s4 = peg$parseunstressed_syllable();
          if (s4 !== peg$FAILED) {
            s2 = [s2, s3, s4];
            s1 = s2;
          } else {
